...
public class PostController {
	...
	public ResponseEntity<String> getLikeIncreamentHandler(@PathVariable ("id") Integer id) throws PostException{
		return new ResponseEntity<String>(postService.incrementLike(id),HttpStatus.OK);
	}
	
	@CrossOrigin
	@PostMapping("/posts/{id}/unlike")
	public ResponseEntity<String> getLikeDecreamentHandler(@PathVariable ("id") Integer id) throws PostException{
		return new ResponseEntity<String>(postService.decrementLike(id),HttpStatus.OK);
	}
	...
	@CrossOrigin
	@GetMapping("/analytics/posts/topLiked")
